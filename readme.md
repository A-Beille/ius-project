...
<img onclick="window.open('https://ius-project.herokuapp.com');" src="./icon-ius.png" height="70" style="cursor: pointer;" title="Revenir &agrave; l'accueil">
 <div class="b">
...
<h5>🄯 iUS Project. Merci de ne pas faire de l'argent en utilisant nos bots.<br>En utilisant nos bots, vous acceptez nos <a href="./terms">conditions d'utilisation</a>.</h5>
<img src="./icon-discord.png" style="height: 4%;cursor: pointer;" onclick="window.open('https://discord.gg/XbYQNwgSGh','_blank')">
<img src="./icon-stradivarius.png" style="height: 4%;cursor: pointer;" onclick="window.open('https://stradivarius.herokuapp.com','_blank')">
</BODY>
